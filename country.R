...
ggplot(avg_sleep_time, aes(x = country, y = avg_sleeps_longest_stretch_time, fill = country)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_text(aes(label = avg_sleeps_longest_stretch_time), vjust = 1.5, position = position_dodge(2), size = 3) +
...
ggplot(avg_sleep_time, aes(x = country, y = avg_baby_sleep_time, fill = country)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_text(aes(label = avg_baby_sleep_time), vjust = 1.5, position = position_dodge(2), size = 3) +
  scale_fill_brewer(palette = "Set1") +
...
ggplot(avg_sleep_time, aes(x = country, y = avg_baby_wake_time, fill = country)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_text(aes(label = avg_baby_wake_time), vjust = 1.5, position = position_dodge(2), size = 3) +
  scale_fill_brewer(palette = "Set1") +
...
ggplot(avg_sleep_time, aes(x = country, y = avg_baby_total_sleep_time, fill = country)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_text(aes(label = avg_baby_total_sleep_time), vjust = 1.5, position = position_dodge(2), size = 3) +
  scale_fill_brewer(palette = "Set1") +
...
ggplot(avg_sleep_time, aes(x = country, y = avg_past_week_average_woken_up, fill = country)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_text(aes(label = sprintf("%.2f", avg_past_week_average_woken_up)), vjust = 1.5, position = position_dodge(2), size = 3) +
  scale_fill_brewer(palette = "Set1") +
